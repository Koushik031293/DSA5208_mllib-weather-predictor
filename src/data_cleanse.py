...
data_path = "gs://dsa5208-mllib-weather-predict/data/compacted/2024.parquet"
...
output_path = "gs://dsa5208-mllib-weather-predict/data/cleansed/2024_cleansed.parquet"

# df.coalesce(1).write.mode("overwrite").parquet(output_path)

df.repartition(128).write.mode("overwrite") \
...
train_output = "gs://dsa5208-mllib-weather-predict/data/train_2024.parquet"
test_output  = "gs://dsa5208-mllib-weather-predict/data/test_2024.parquet"


(train_df.repartition(128).write.mode("overwrite") \
  .option("compression","snappy") \
  .option("maxRecordsPerFile", 500_000) \
...
(test_df.repartition(128).write.mode("overwrite") \
  .option("compression","snappy") \
  .option("maxRecordsPerFile", 500_000) \
  .parquet(test_output)
)
